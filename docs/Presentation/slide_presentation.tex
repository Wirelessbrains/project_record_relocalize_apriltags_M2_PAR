...
\input{sections/recordin_phase.tex}
\end{frame}

\begin{frame}[label=slide-relocalization]{Relocalization Phase}
\input{sections/reloc_phase.tex}
\end{frame}
...
\centering
\begin{tikzpicture}[x=1cm,y=1cm]
  % Clickable video thumbnail (2x version)
  \node[inner sep=0pt, anchor=south west] at (0.45,0.55)
    {\href{run:assets/Reloc_scnerio2_2x.mp4}{\includegraphics[width=11.10cm,height=5.10cm]{assets/scneario2.jpeg}}};
...
\input{sections/discution_conclusion.tex}
\end{frame}
...
\begin{frame}[plain]
	...
	{\Large\bfseries\textcolor{DarkBlue}{Acknowledgements}\par}
	\vspace{0.25cm}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item \hyperlink{appendix-synth-noisefree}{\textbf{Optimized tag map and reconstructed camera trajectory in the noise-free scenario.}}
        \item \hyperlink{appendix-synth-noisy}{\textbf{Optimized tag map and reconstructed trajectory under 10 cm Gaussian noise.}}
        \item \hyperlink{appendix-mosaic-architecture}{\textbf{Physical and simulated setups used to evaluate the proposed architecture.}}
        \item \hyperlink{appendix-mosaic-detection}{\textbf{Representative detection, each detected tag yields a camera-relative pose estimate obtained through a PnP formulation.}}
        \item \hyperlink{appendix-mosaic-rec-traj}{\textbf{Reconstructed camera trajectory obtained after map optimization.}}
        \item \hyperlink{appendix-mosaic-compare-gt}{\textbf{Comparison between optimized reconstruction and ground-truth configuration.}}
        \item \hyperlink{appendix-mosaic-synth-points}{\textbf{Representative synthetic points used to validate the computation of $D$ in the YZ plane.}}
        \item \hyperlink{appendix-mosaic-real-recording}{\textbf{Real recording setup and corresponding reconstructed trajectory result.}}
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item \hyperlink{appendix-mosaic-real-relocal}{\textbf{Real relocalization validation setup and corresponding distance comparison.}}
        \item \hyperlink{appendix-mosaic-second-recording}{\textbf{Additional real recording result processed with the same offline pipeline.}}
        \item \hyperlink{appendix-discussion-recording-limitations}{\textbf{Discussion - Recording Limitations}}
        \item \hyperlink{appendix-flowchart-recording}{\textbf{Architecture of the offline recording pipeline.}}
        \item \hyperlink{appendix-flowchart-relocal}{\textbf{Architecture of the relocalization pipeline with separated offline analysis and online execution.}}
        \item \hyperlink{appendix-table-20}{\textbf{Table 2.0: Functional Requirements}}
        \item \hyperlink{appendix-table-21}{\textbf{Table 2.1: Non-Functional Requirements}}
        \item \hyperlink{appendix-table-22}{\textbf{Table 2.2: Project Deliverables and Constraints}}
        \item \hyperlink{appendix-table-23}{\textbf{Table 2.3: Technical Limitations}}
        \item \hyperlink{appendix-table-41}{\textbf{Table 4.1: Residual errors in the ideal scenario (no noise).}}
        \item \hyperlink{appendix-table-42}{\textbf{Table 4.2: Error statistics under 10 cm Gaussian noise.}}
        \item \hyperlink{appendix-table-43}{\textbf{Table 4.3: Summary table with estimated versus measured distance to the recorded trajectory and the estimated heading offset $\phi$.}}
        \item \hyperlink{appendix-table-a1}{\textbf{Table A.1: Comparison between estimated and measured distances from tag 16.}}
      \end{itemize}
    \end{column}
  \end{columns}
\end{outlinecard}
\end{frame}
\begin{frame}[noframenumbering]{Appendix Summary (Continued)}
\transfade[duration=0.25]
\begin{outlinecard}[Appendix Media]
  \tiny
  \begin{itemize}
    \item \hyperlink{appendix-media-validation-exp2}{\textbf{Appendix Media - Validation Experiment 2 (Large)}}
    \item \hyperlink{appendix-media-reloc-demo1}{\textbf{Appendix Media - reloc\_demo1.webm}}
    \item \hyperlink{appendix-media-reloc-demo2}{\textbf{Appendix Media - reloc\_demo2.webm}}
    \item \hyperlink{appendix-media-reloc-real1}{\textbf{Appendix Media - reloc\_real\_scneario\_1.webm}}
    \item \hyperlink{appendix-media-reloc-scn2}{\textbf{Appendix Media - Reloc\_scnerio2.webm}}
    \item \hyperlink{appendix-media-traj1}{\textbf{Appendix Media - trajetory\_1\_4x\_cropped.mp4}}
  \end{itemize}
\end{outlinecard}
\end{frame}
\startappendixframes
\input{sections/annex_simulation.tex}
\end{document}
